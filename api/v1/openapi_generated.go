...
func schema_kmodulesxyz_monitoring_agent_api_api_v1_PrometheusSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"metricRelabelings": {
						SchemaProps: spec.SchemaProps{
							Description: "MetricRelabelings configuration of ServiceMonitor object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"relabelings": {
						SchemaProps: spec.SchemaProps{
							Description: "Relabelings configuration of ServiceMonitor object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/coreos/prometheus-operator/pkg/apis/monitoring/v1.RelabelConfig"},
	}
}
